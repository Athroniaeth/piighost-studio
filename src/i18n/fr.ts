...
export const fr: Dictionary = {
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: "De quoi ai-je besoin pour faire tourner piighost en production ?",
        answer: [
      ...
      {
        question: "Est-ce que je peux utiliser piighost avec LangChain, Pydantic AI ou LlamaIndex ?",
        answer: [
      ...
      {
        question: "Est-ce que piighost est conforme au RGPD, et comment fonctionnent les jetons stables ?",
        answer: [
