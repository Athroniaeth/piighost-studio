...
export const en: Dictionary = {
  ...
  playground: {
    ...
    entityLinkerHelp: "Links repeats of the same value so they share a placeholder.",
    entityResolverHelp: "Merges linked entities; fuzzy also matches typos and case.",
